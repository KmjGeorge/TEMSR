...
if __name__ == '__main__':
    net = Restormer_Backbone(inp_channels=1, out_channels=64, dim=48, num_blocks=[4, 6, 6, 8], num_refinement_blocks=4, heads=[1,2,4,8], ffn_expansion_factor=2.66, bias=False, LayerNorm_type='WithBias', dual_pixel_task=False, global_residual=False).cuda()
