...
class HAT(nn.Module):
    ...
    def __init__(self,
        ...
        if in_chans == 3:
            ...
            # self.mean = torch.Tensor(rggb_mean).view(1, 4, 1, 1)
        else:
        ...
        # self.mixstyle = MixStyle(p=0.3, alpha=0.5)
...
if __name__ == '__main__':
    ...
    model = HAT(img_size=128, in_chans=1, upscale=1, upsampler='Denoise', window_size=8, compress_ratio=3, squeeze_factor=30, overlap_ratio=0.5, img_range=1., depths=[6, 6, 6, 6, 6, 6], num_heads=[6, 6, 6,6,6,6],
                mlp_ratio=2, embed_dim=96).cuda()
