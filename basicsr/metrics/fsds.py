...
def calculate_fsds(img, img2, crop_border, test_y_channel=False):
    """
    FrequencySpectrumDistributionSimilarity
    """
    ...
    img2 = torch.from_numpy(img2.astype(np.float64))

    return _FrequencySpectrumDistributionSimilarity(img, img2)
