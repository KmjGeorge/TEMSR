...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default=  # noqa: E251
        r'F:\github\TEMSR\experiments\old\InstructIR_32_2248_12_2222_p256b8_tdim256_2gpu_5task fft0.05\models\net_g_200000.pth'
    )
    parser.add_argument("--lm_path", type=str, default=r'F:\github\TEMSR\models\lm_head\model_head_256_dndbseglliesr_epoch40.pth',
                        help='embedding model head path')
    parser.add_argument('--output', type=str, default='../show/InstructIR_p256b8_2gpu_5task_2',
                        help='output folder')
