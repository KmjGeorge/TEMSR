...
def main():
    ...
    parser.add_argument("--lm_path", type=str, default='../models/lm_head/model_head_20.pth',
        ...
        if os.path.exists(os.path.join(filefolder, filename)):
            ...
            try:
                ...
                save_path = os.path.join(args.output,
                                         filename.replace('.png', '_CSwinv2UNet_{}_{}.png'.format(prompt,inverse_dict[pred_cls])))
